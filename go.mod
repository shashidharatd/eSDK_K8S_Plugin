...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.17.7-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.17.7-rc.0
...
replace k8s.io/node-api => k8s.io/node-api v0.17.6

replace k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.17.6

replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.17.6

replace k8s.io/sample-controller => k8s.io/sample-controller v0.17.6
